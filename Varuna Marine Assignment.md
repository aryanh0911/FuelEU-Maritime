...
[Notion Link](https://www.notion.so/Agent-Tasks-29651e79ddc880dca828f04db6b69e87?source=copy_link)

# FullStack Developer

# FuelEU Maritime — Full-Stack Developer Assignment

This assignment assesses your **engineering ability**, **architectural clarity**, and **use of AI agents** (such as _GitHub Copilot_, _Claude Code_, _Cursor Agent_, _OpenAI Codex_, etc.).
...
5. Deadline: _72 hours from assignment receipt_.
